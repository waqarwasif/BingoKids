...
const HeroSection = () => {
  ...
  return (
    <section className="bg-brand-purple w-full relative overflow-hidden" ref={revealRef}>
      ...
      <div className="absolute top-20 right-[10%] w-64 h-64 bg-[#ff6699]/20 rounded-full blur-[80px] animate-[pulse_6s_ease-in-out_infinite]"></div>
      <div className="absolute bottom-40 left-[5%] w-72 h-72 bg-[#00c896]/20 rounded-full blur-[100px] animate-[pulse_8s_ease-in-out_infinite]"></div>
      <div className="absolute top-40 left-[20%] text-[#ffc42e] animate-[spin_10s_linear_infinite] opacity-60">
      ...
      <div className="absolute bottom-60 right-[25%] text-[#3cebf2] animate-[spin_15s_linear_infinite_reverse] opacity-60">
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-16 pt-32 pb-48 flex flex-col lg:flex-row items-center gap-12 relative z-10">
        
        {/* Left Content */}
        <div className="w-full lg:w-[45%] flex flex-col items-center lg:items-start text-center lg:text-left gap-6 lg:mt-[-50px]">
          <h1 className="font-display font-black text-[50px] lg:text-[76px] tracking-[-0.02em] leading-[1.05] max-w-[500px] drop-shadow-lg">
            <span className="text-white">Ultimate kids</span><br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ffc42e] via-[#ff6699] to-[#3cebf2]">
              entertainment
            </span>
          </h1>
          <p className="font-body font-bold text-xl lg:text-[24px] text-white/90 max-w-[400px] leading-[1.4] mb-2 drop-shadow-md">
        ...
        <div className="w-full lg:w-[55%] flex justify-center lg:justify-end relative group perspective-[1000px]">
          ...
          {/* Decorative backdrop to make it pop more */}
          <div className="absolute inset-0 bg-gradient-to-tr from-[#ff6699] to-[#ffc42e] rounded-[32px] blur-3xl opacity-30 group-hover:opacity-50 transition-opacity duration-700 w-full max-w-[760px] ml-auto"></div>

          <div className="relative w-full max-w-[760px] aspect-[16/11] bg-[#eef1f6] rounded-[32px] overflow-hidden border-[6px] border-white shadow-[0_30px_60px_rgba(0,0,0,0.4)] transform rotate-2 transition-all duration-700 group-hover:-rotate-1 group-hover:scale-[1.02]">
             {homeHero.video ? (
               <video 
                 src={homeHero.video} 
                 autoPlay 
...
const OnDemandSection = () => {
  const revealRef = useScrollReveal();
  return (
    <section className="bg-brand-orange w-full py-20 lg:py-32 overflow-hidden relative" ref={revealRef}>
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 flex flex-col items-center gap-8 mb-16 relative z-10">
        <h2 className="font-display font-black text-5xl lg:text-[72px] text-white text-center leading-tight drop-shadow-[4px_4px_0_rgba(46,26,71,0.2)]">
          Incredible content. <br className="hidden md:block" />
          <span className="text-brand-purple">On demand.</span>
        </h2>
      </div>
        ...
        <div className="flex w-[200%] md:w-[200%] lg:w-[200%]">
          <div className="flex w-full animate-marquee">
            {[...cardsRow1, ...cardsRow1].map((card, idx) => (
              <div key={idx} className="w-[200px] md:w-[260px] lg:w-[300px] aspect-square flex-shrink-0 mx-4 bg-white p-4 pb-12 rounded-[2rem] shadow-[0_15px_30px_rgba(46,26,71,0.15)] flex flex-col items-center justify-center overflow-hidden transform hover:-translate-y-4 hover:rotate-2 hover:scale-105 transition-all duration-500 cursor-crosshair group">
...
const FiveMoreMinutesSection = () => {
  ...
  return (
    <section className="bg-brand-cream w-full py-20 lg:py-32 relative overflow-hidden" ref={revealRef}>
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-bl from-[#ffbdf4]/40 to-transparent rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 pointer-events-none"></div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-16 flex flex-col lg:flex-row items-center gap-16 relative z-10">
        ...
        <div className="w-full lg:w-1/2 flex justify-center lg:justify-start group">
          <div className="relative w-full max-w-[500px] aspect-square transition-transform duration-700 group-hover:scale-[1.02]">
            {/* Shadow backdrop */}
            <div className="absolute inset-0 bg-[#180a2b] rounded-[40px] translate-x-6 translate-y-6 opacity-20 group-hover:translate-x-8 group-hover:translate-y-8 transition-transform duration-500"></div>
            ...
            <div className="absolute -bottom-6 -right-6 bg-brand-yellow rounded-full p-6 shadow-[4px_4px_0_0_rgba(46,26,71,1)] border-4 border-brand-purple animate-[bounce_4s_infinite] z-20 hover:scale-110 transition-transform cursor-pointer">
              <span className="text-5xl">✨</span>
            </div>
            
            {/* Secondary Floating Element */}
            <div className="absolute -top-6 -left-6 bg-[#3cebf2] text-brand-purple font-display font-black text-xl py-3 px-6 rounded-[20px] shadow-[4px_4px_0_0_rgba(46,26,71,1)] border-4 border-brand-purple rotate-[15deg] z-20 hover:-rotate-[5deg] transition-transform duration-500">
              100% Safe
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left gap-8">
          <h2 className="font-display font-black text-5xl lg:text-7xl text-brand-purple leading-[1.1] drop-shadow-sm">
            "Just five more<br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff6699] to-[#ff9500]">
              minutes!"
            </span>
          </h2>
          <p className="font-body font-medium text-2xl text-brand-purple/80 max-w-[480px]">
          ...
          <div className="flex flex-col gap-5 w-full mt-4 group/list">
            {homeFeatures.map((feature, idx) => (
              <div 
                key={idx} 
                className={`flex items-start gap-6 p-6 rounded-[24px] bg-white shadow-[0_8px_30px_rgba(46,26,71,0.08)] border-2 border-transparent hover:border-brand-purple hover:shadow-[8px_8px_0_0_rgba(46,26,71,1)] hover:bg-[#f8faff] transition-all duration-300 transform hover:-translate-y-1 cursor-pointer`}
              >
                <div className={`w-16 h-16 rounded-[20px] shrink-0 p-2 bg-[#f0f4ff]`}>
                ...
                <div className="flex flex-col items-start text-left mt-1">
                  <h3 className="font-display font-black text-[28px] text-brand-purple mb-2 leading-none">{feature.title}</h3>
                  <p className="font-body text-lg text-brand-purple/70 leading-snug">{feature.description}</p>
                </div>
              </div>
            ))}
          </div>
...
const SeriousAboutFunSection = () => {
  ...
  return (
    <section 
      className="bg-[#180a2b] w-full relative overflow-hidden flex flex-col items-center pt-24 lg:pt-40 pb-24" 
      ref={revealRef}
    >
      {/* Deep Space Animated Background */}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-[20%] left-[10%] w-[500px] h-[500px] bg-[#6600cc] rounded-full blur-[120px] opacity-40 animate-[pulse_10s_ease-in-out_infinite]"></div>
        <div className="absolute bottom-[10%] right-[5%] w-[600px] h-[600px] bg-[#ff0066] rounded-full blur-[150px] opacity-20 animate-[pulse_12s_ease-in-out_infinite_reverse]"></div>
        <div className="absolute top-[40%] right-[30%] w-[300px] h-[300px] bg-[#00ffcc] rounded-full blur-[100px] opacity-20 animate-[pulse_8s_ease-in-out_infinite]"></div>
        
        {/* Starfield overlay (subtle static texture) */}
        <div className="absolute inset-0 opacity-30" style={{ backgroundImage: 'radial-gradient(circle, #fff 1px, transparent 1px)', backgroundSize: '60px 60px', backgroundPosition: '0 0, 30px 30px' }}></div>
      </div>

      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 flex flex-col items-center relative z-20">
        <h2 className="font-display font-black text-5xl lg:text-[80px] text-white text-center mb-6 tracking-tight" style={{ textShadow: '0 0 40px rgba(102,0,204,0.8), 0 0 100px rgba(255,0,102,0.4)' }}>
          Serious about <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff0066] to-[#ffc42e]">fun</span>
        </h2>
        
        <p className="font-body font-bold text-2xl lg:text-[32px] text-white/90 text-center max-w-[700px] mb-20 drop-shadow-lg leading-snug">
          The best educational experts in the world agree: <span className="text-[#00ffcc] animate-pulse">fun works.</span>
        </p>
...
const TestimonialsSection = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-[#ffbdf4] to-[#f4d6ee] w-full py-20 lg:py-32 relative overflow-hidden" ref={revealRef}>
      
      {/* Decorative background shapes */}
      <div className="absolute top-10 left-10 w-32 h-32 bg-white/20 rounded-full blur-xl animate-pulse"></div>
      <div className="absolute bottom-20 right-20 w-48 h-48 bg-[#ff6699]/10 rounded-full blur-2xl animate-[pulse_6s_ease-in-out_infinite]"></div>

      <div className="max-w-[1280px] mx-auto px-6 lg:px-24 flex flex-col items-center gap-16 relative z-10">
        <div className="flex flex-col items-center text-center">
          <h2 className="font-display font-black text-5xl lg:text-[64px] leading-tight text-brand-purple mb-4 drop-shadow-sm">
            Loved by <span className="text-[#ff6699]">200M</span> families
          </h2>
          <p className="font-body font-bold text-2xl lg:text-3xl text-brand-purple/80">Adored by kids and grown-ups alike.</p>
        </div>
        ...
        <Carousel 
          ...
          renderItem={(testimonial) => {
            if (testimonial.type === 'photo') {
              return (
                <div className="rounded-[40px] overflow-hidden h-[480px] w-full shadow-[0_20px_40px_rgba(46,26,71,0.2)] border-8 border-white transform transition-transform duration-500 hover:scale-[1.02]">
            ...
            return (
              <div className="relative h-[480px] w-full group">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#ff6699] via-[#ffc42e] to-[#3cebf2] rounded-[40px] rounded-br-none opacity-0 group-hover:opacity-100 blur-md transition-opacity duration-500 animate-[spin_4s_linear_infinite]"></div>
                
                {/* Actual Card (Speech Bubble) */}
                <div className="absolute inset-1 bg-white rounded-[40px] rounded-br-none p-10 lg:p-12 flex flex-col justify-between shadow-[inset_0_-8px_0_rgba(0,0,0,0.05),_0_20px_40px_rgba(46,26,71,0.1)] z-10">
                   ...
                   <div>
                     <div className="flex flex-wrap items-center gap-4 mb-8">
                       <span className="bg-gradient-to-r from-[#007aff] to-[#00c896] text-white text-[12px] font-black px-4 py-1.5 rounded-full flex items-center gap-2 uppercase tracking-widest shadow-md">
                     ...
                     <h3 className="font-display font-black text-3xl lg:text-[32px] text-brand-purple mb-5 leading-tight">{testimonial.title}</h3>
                     <p className="font-body text-[18px] lg:text-[20px] font-medium text-brand-purple/70 leading-relaxed">"{testimonial.text}"</p>
                   </div>
                   <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#f4d6ee] flex items-center justify-center text-xl shadow-inner">
                        👤
                      </div>
                      <p className="font-display font-bold text-[18px] text-brand-purple">{testimonial.author}</p>
                   </div>
                </div>
              </div>
            );
    ...
    <section className="relative w-full py-24 overflow-hidden bg-[#fff9f0]" ref={revealRef}>
      ...
      <div className="max-w-[1440px] mx-auto px-6 flex flex-col items-center">
        ...
        <div className="text-center max-w-4xl mb-16 relative z-10">
          <div className="absolute -top-12 -left-12 text-[#ff8c00] animate-[spin_8s_linear_infinite] hidden md:block">
            <svg width="70" height="70" viewBox="0 0 24 24" fill="currentColor">
              <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
            </svg>
          </div>
          <h2 className="font-display font-black text-5xl md:text-6xl lg:text-7xl text-[#2E1A47] leading-[1.1] drop-shadow-sm">
            Award-winning, <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff6699] via-[#8b5cf6] to-[#00c896]">again & again.</span>
          </h2>
          <p className="font-body text-xl lg:text-2xl font-bold text-[#2E1A47]/70 mt-6">
        ...
        <div className="relative z-10 w-full max-w-[800px] mb-24 group px-4">
          ...
          <div className="absolute inset-0 bg-[#00c896] rounded-[3rem] rotate-3 transition-transform duration-500 group-hover:rotate-[6deg] shadow-lg"></div>
          <div className="absolute inset-0 bg-[#8b5cf6] rounded-[3rem] -rotate-3 transition-transform duration-500 group-hover:-rotate-[6deg] shadow-lg"></div>
          
          {/* Main Image Container */}
          <div className="relative bg-white p-3 lg:p-5 rounded-[3rem] shadow-[0_20px_40px_rgba(46,26,71,0.2)] transition-transform duration-500 group-hover:-translate-y-4 border-4 border-white">
            <img 
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-6 -right-2 lg:-right-6 bg-[#ff6699] text-white font-display font-bold text-xl py-3 px-8 rounded-full shadow-[6px_6px_0_0_#2E1A47] rotate-[-12deg] group-hover:scale-110 transition-transform duration-300 border-2 border-[#2E1A47]">
              #1 Rated!
            </div>
          </div>
        </div>
      ...
      <div className="w-full bg-[#ff8c00] py-5 border-y-4 border-[#2E1A47] transform rotate-1 relative z-20 shadow-[0_10px_30px_rgba(46,26,71,0.15)] overflow-hidden">
...
const NoAdsSection = () => {
  const revealRef = useScrollReveal();
  return (
    <section className="bg-gradient-to-b from-[#b7f0ff] to-[#e0f7fa] w-full py-24 lg:py-32 relative overflow-hidden" ref={revealRef}>
      ...
      <div className="absolute bottom-40 right-20 w-64 h-64 bg-[#ffbdf4]/40 rounded-full blur-3xl animate-[pulse_8s_ease-in-out_infinite]"></div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 flex flex-col items-center relative z-10">
        ...
        <div className="flex flex-col items-center text-center gap-6 mb-24">
          <div className="w-20 h-20 bg-gradient-to-br from-[#ff8c00] to-[#ffcc33] rounded-3xl flex items-center justify-center p-4 shadow-[0_10px_20px_rgba(255,140,0,0.3)] animate-bounce" style={{ animationDuration: '3s' }}>
          ...
          <h2 className="font-display font-black text-6xl lg:text-[80px] text-[#2E1A47] uppercase tracking-tight mt-2 drop-shadow-sm leading-[1.1]">
            NO ADS. <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff6699] to-[#8b5cf6]">EVER.</span>
          </h2>
          
          <p className="font-body font-bold text-2xl lg:text-3xl text-[#2E1A47]/80 max-w-2xl leading-snug mt-2">
            Designed for safe entertainment, without interruption.
          </p>
          
          <div className="mt-8">
            <Button as="a" href="#" variant="secondary" className="px-12 py-5 text-2xl shadow-2xl">
              Download free
            </Button>
          </div>
        </div>
        ...
        {/* Bottom Grid */}
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center mt-4">
          ...
          <div className="relative group w-full">
            ...
            <div className="relative w-full rounded-[3rem] overflow-hidden aspect-[4/3] bg-white p-3 lg:p-4 shadow-[0_20px_50px_rgba(46,26,71,0.2)] transform transition-transform duration-700 group-hover:rotate-2 group-hover:scale-[1.02] border-4 border-white">
              ...
              {/* Floating safe badge */}
              <div className="absolute top-8 left-8 bg-white/90 backdrop-blur-md px-5 py-2.5 rounded-full font-bold text-[#00c896] shadow-xl flex items-center gap-2 border-2 border-white group-hover:-translate-y-2 transition-transform duration-500">
          ...
          {/* Right: Download Info */}
          <div className="flex flex-col items-start gap-8 lg:pl-8">
            <h3 className="font-display font-black text-4xl lg:text-5xl text-[#2E1A47] leading-tight drop-shadow-sm">

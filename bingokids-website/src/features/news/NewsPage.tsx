    ...
    <section className="bg-[#F4F9FF] w-full py-20 lg:py-32 relative overflow-hidden" ref={revealRef}>
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 flex flex-col gap-16 lg:gap-20 items-center relative z-10">
        <div className="flex flex-col items-center gap-4 text-center relative w-full max-w-2xl mx-auto mt-8">
          <h2 className="font-display font-black text-4xl sm:text-5xl lg:text-7xl text-[#002B66] tracking-tight">
...
const DiveDeeperSection = () => {
  const revealRef = useScrollReveal();
  return (
    <section className="bg-gradient-to-b from-[#00A86B] via-[#00897B] to-[#004D40] w-full py-16 lg:py-24 relative overflow-hidden" ref={revealRef}>
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 flex flex-col gap-12 relative z-10">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="relative">
             <h2 className="font-display font-black text-3xl sm:text-4xl lg:text-6xl text-white relative z-10 drop-shadow-md">
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 flex flex-col gap-16 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative">
          <div className="relative text-center md:text-left">
             <h2 className="font-display font-black text-4xl sm:text-5xl lg:text-7xl text-white relative z-10 drop-shadow-md">
               In the <span className="text-[#FFD600]">media</span>
             </h2>
          </div>
  ...
  return (
    <section className="bg-[#FFFDF0] w-full py-16 lg:py-24" ref={revealRef}>
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 flex flex-col gap-16 items-center">
        <h2 className="font-display font-black text-3xl sm:text-4xl lg:text-6xl text-[#002B66] text-center drop-shadow-sm">Press pack</h2>
...
export const NewsPage = () => {
  return (
    <div className="w-full flex flex-col min-h-screen">
      ...
      <InTheMediaSection />
      <PressPackSection />
      <Footer showQrCard={false} footerBgColorClass="bg-[#00A86B]" />
    </div>
  );
};
